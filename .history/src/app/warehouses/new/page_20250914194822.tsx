  ...
  return (
    <main className="flex min-h-screen bg-slate-950 text-white">
      ...
      <section className="flex min-h-screen flex-1 flex-col">
        ...
        {/* Carte plein écran dans la zone de contenu */}
        <div className="relative flex-1">
          ...
          {/* Overlay bas-droit : sélection + bouton bleu */}
          ...
          {/* Toast centré bas */}
          {toast && (
            <div className="absolute left-1/2 bottom-4 -translate-x-1/2 z-10 rounded-xl border border-white/10 bg-neutral-950/85 px-4 py-2 text-sm">
              {toast}
            </div>
          )}
