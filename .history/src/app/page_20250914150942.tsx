          ...
          <div className="grid items-center gap-10 md:grid-cols-2">
            <div>
              <h1 className="text-4xl font-extrabold leading-tight tracking-tight md:text-5xl">
                Bâtis ton empire multimodal.
              </h1>
              <p className="mt-4 text-white/80">
                Déploie ton réseau routier, ouvre des entrepôts, automatise tes centres de tri
                et étends-toi au <span className="font-semibold text-cyan-300">fret aérien</span>.
                Cartes mises à jour ~10 s, anti-triche côté serveur PlayFab.
              </p>
              ...
              <ul className="mt-8 grid max-w-xl gap-3 text-white/80">
                {[
                  "Réseau vivant : positions véhicules mises à jour ~10 s (interpolation fluide).",
                  "Économie persistance PlayFab : sécurité et progression serveur.",
                  "Planification intelligente : SLA, pénalités, coûts réels (carburant, maintenance).",
                ].map((t) => (
            ...
            {/* Bloc visuel simple (remplace la fausse carte) */}
            <div className="relative">
              <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-white/5 to-white/[0.02] p-6 shadow-2xl">
                ...
                <ul className="mt-4 space-y-2 text-white/80">
                  <li>• Entrepôts & stocks (FIFO, sécurité, inventaires)</li>
                  <li>• Centres de tri (hub & spoke, priorisation, cut-off)</li>
                  <li>• Fret aérien (lignes cargo, escales, capacités avion)</li>
                  <li>• Routier longue distance & dernier km</li>
                  <li>• Douanes & SLA (incoterms, délais, pénalités)</li>
                </ul>
                <div className="mt-6 text-sm text-white/60">
                  À venir : rail & multimodal avancé, météo impact, bourse de fret.
                </div>
              </div>
      ...
      <section id="features" className="relative border-t border-white/10">
        <div className="mx-auto max-w-6xl px-4 py-16">
          ...
          <p className="mt-2 max-w-2xl text-white/70">
            Conçois un réseau efficace, arbitre entre vitesse et coût, et domine le marché grâce
            à une exécution précise de bout en bout.
          </p>

          <div className="mt-10 grid gap-6 md:grid-cols-3">
            <Feature
              title="Entrepôts & stocks"
              desc="Crée des dépôts régionaux, gère les emplacements, la rotation (FIFO), les ruptures et les coûts d’entreposage."
              icon={
            ...
            <Feature
              ...
              desc="Optimise tes hubs : vagues de tri, cut-off, cross-docking, priorité par SLA. Réduis les délais sans exploser les coûts."
              icon={
                <svg viewBox="0 0 24 24" className="h-6 w-6" aria-hidden>
            ...
            <Feature
              title="Fret aérien"
              desc="Ouvre des lignes cargo, réserve des capacités, gère les escales, les temps sols et les palettes ULD."
              icon={
                <svg viewBox="0 0 24 24" className="h-6 w-6" aria-hidden>
            ...
            <Feature
              ...
              desc="Flotte, planning chauffeurs, itinéraires, péages, carburant, maintenance, disponibilité et temps de coupure."
              icon={
                <svg viewBox="0 0 24 24" className="h-6 w-6" aria-hidden>
            ...
            <Feature
              title="SLA & douanes"
              desc="Engagements de service, incoterms, contrôles, pénalités. Maîtrise les goulots pour tenir tes promesses."
              icon={
                <svg viewBox="0 0 24 24" className="h-6 w-6" aria-hidden>
            ...
            <Feature
              title="Planification"
              desc="Simule les vagues, calibre les cut-off, arbitre coût vs vitesse. Tes décisions impactent la carte toutes ~10 s."
              icon={
                <svg viewBox="0 0 24 24" className="h-6 w-6" aria-hidden>
          ...
          <div className="mt-12 flex flex-wrap items-center gap-3">
            ...
            <span className="text-sm text-white/60">
              Auth & sauvegarde PlayFab arrivent très vite.
            </span>
          </div>
        </div>
      </section>
