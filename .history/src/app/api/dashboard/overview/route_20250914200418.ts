...
export async function GET() {
  try {
    ...
    // Exemple de statistiques (niveau/xp si tu les utilises via PlayerStatistics)
    ...
    // Remonte l’erreur PlayFab de façon transparente
    const payload = {
      error: "PlayFabError",
