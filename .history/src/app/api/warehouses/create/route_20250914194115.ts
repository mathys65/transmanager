...
const PRICE_EU = 100_000; // prix standard
...
export async function POST(req: Request) {
  ...
  // Lire la liste pour savoir si c'est le premier (offert)
  ...
  const item = {
    ...
    vehicleSlots: BASE_SLOTS,   // 1 véhicule
    staffSlots: BASE_STAFF,     // 2 personnels
  };
  items.push(item);
