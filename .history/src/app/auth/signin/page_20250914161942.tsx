...
export default function SigninPage() {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (!res.ok) {
        setErr(json?.error || "Échec de la connexion.");
        return;
      }

      // 🔑 L’API renvoie { ok: true, requireTerms: boolean }
      if (json?.requireTerms) {
        window.location.href = "/legal/accept";
      } else {
        // Redirige vers l’accueil (ou /game quand prêt)
