    ...
    >
      ...
      <div className="flex h-16 items-center justify-between px-3">
        <div className="flex items-center gap-2">
          ...
          {open && (
            <SafeLink href="/dashboard" className="text-base font-semibold text-white">
              TransManager
            </SafeLink>
          )}
        </div>
              ...
              {item.href && !hasChildren ? (
                <SafeLink
                  ...
                  className={
                    base +
                    " " +
                    (isActive(item.href) ? "bg-white/15 text-white" : "text-white/90 hover:bg-white/10")
                  }
                >
                  {RowInner}
                </SafeLink>
                ...
                <button
                  ...
                  className={base + " text-white/90 hover:bg-white/10 w-full text-left"}
                >
                  {RowInner}
                </button>
              )}
